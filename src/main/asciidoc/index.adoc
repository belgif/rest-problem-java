...
WARNING: Use these extensions at your own discretion. They are not an official part of the Belgif REST guidelines, may have an impact on interoperability, and may potentially be changed or removed in a future version.

[[belgif-ext-issue-types]]
=== Specialized issue types

Property: `io.github.belgif.rest.problem.ext.issue-types`
...
Property: `io.github.belgif.rest.problem.ext.inputs-array`
