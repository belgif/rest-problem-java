...
public class NotFoundExceptionMapperTest {
    ...
    public void testParseLocation() {
        Response response = new NotFoundExceptionMapper().toResponse(new NotFoundException(
                "RESTEASY003870: Unable to extract parameter from http request: jakarta.ws.rs.QueryParam(\"startDate_gt\") value is '2006-087-01'",
